            ...
            <table class="box-table-content" style="border: 0px">
                <tr>
                    ...
                    <td class="box-table-table">
                        <table cellpadding="8">
                            <tr>
                                <th class="td-gray"><div>สำหรับเจ้าหน้าที่ธนาคาร</div></th>
                            </tr>
                            <tr>
                                <td>
                                    <span>ผู้รับเงิน </span><div class="enter-content" style="margin-left: 45px;"></div>
                                </td>
                            </tr>
                        </table>
                    </td>
...
ARw3CERWg3zaAAAAAElFTkSuQmCC' class="check-img"/></td>
        ...
        <div class="box-table">
            ...
            <table class="box-table-content" style="margin-top: 5px">
                <tr>
                    <td>
                        <div style="padding-bottom: 15px"><div>ชื่อผู้นำฝาก/Deposit by</div><div class="enter-content wid-140" style="margin-left: 125px;"></div></div>
                        <div><div>โทรศัพท์/Telephone </div><div class="enter-content" style="margin-left: 115px;width: 150px"></div></div>
                    </td>
